                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <!-- form -->
                                <!-- urlencode(val) -->
                                <form action="{!! route('factory.store') !!}" method="POST" class="col-sm-8" autocomplete="off" id="form1" enctype="multipart/form-data">
                                    @csrf
                                    <!-- form-group -->
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-10">
                                            <div id="colour_input_group" class="input-group colorpicker-component">
                                                <!-- p class="form-control-static"></p -->
                                                <input type="text" class="form-control" id="colour" name="colour" placeholder="Colour" value="{{ old('colour') }}" required/>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <table id="factoryDataTable" class="table table-bordered" style="width:100%" width="100%" cellspacing="0" border="1" align="left"></table>
                                <!-- /.table -->
                            </div>
                            <!-- /.col -->
                        </div>
...
@section('section_script')
    ...
    @includeIf('partials.factory_data_table_created', array('dataTableId' => 'factoryDataTable'))
    <script>
    $(function() {
        "use strict";
        ...
        $('#form1').submit(function(event) {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    $('#factoryDataTable').DataTable().ajax.reload( null, false ); // user paging is not reset on reload
                    name.val(null);
                    colour_input_group.colorpicker('setValue', defaultColour_1);
                    // scroll top
