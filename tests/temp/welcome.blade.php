...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <!-- ========================================================================= -->
            <div id="container" style="background-color: red; width: 100%; overflow: scroll;"></div>
            <!-- ========================================================================= -->
            ...
            <script>
                ...
                stage.getContainer().style.backgroundColor = 'rgba(0, 0, 0, 0.9)';
                ...
                var colors = ['rgba(20, 30, 90, 0.8)', 'rgba(60, 10, 20, 0.8)', 'rgba(40, 90, 10, 0.8)', 'rgba(10, 50, 85, 0.8)', 'rgba(40, 60, 90, 0.8)', 'rgba(0, 0, 0, 0.8)'];
