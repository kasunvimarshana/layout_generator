                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <!-- form -->
                                <!-- urlencode(val) -->
                                <form action="{!! route('department.update', ['department' => $department->name]) !!}" method="POST" class="col-sm-8" autocomplete="off" id="form1" enctype="multipart/form-data">
                                    @csrf
                                    <!-- form-group -->
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-10">
                                            <div id="colour_input_group" class="input-group colorpicker-component">
                                                <!-- p class="form-control-static"></p -->
                                                <input type="text" class="form-control" id="colour" name="colour" placeholder="Colour" value="{{ $department->colour }}" required/>
...
@section('section_script')
    ...
    $(function() {
        ...
        @isset($department->colour)
            $("#colour_input_group").colorpicker('setValue', "{{ $department->colour }}");
        @endisset
    });
    </script>
@endsection