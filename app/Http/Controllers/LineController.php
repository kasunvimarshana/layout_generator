...
class LineController extends Controller
{
    ...
    {
        //
        if(view()->exists('line_create')){
            return View::make('line_create');
        }
    }
    ...
    {
        //
        if(view()->exists('line_edit')){
            return View::make('line_edit', ['line' => $line]);
        }
    }
    ...
    public function listLines(Request $request){
        ...
        $query = $line->where('is_visible', '=', true);
