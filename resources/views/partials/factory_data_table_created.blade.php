    ...
    var dataTableObject = $('#{!! $dataTableId !!}').DataTable({
        ...
        'columnDefs' : [{
            ...
            'createdCell' : function(td, cellData, rowData, row, col){
                ...
                var backgroundColor = rowData.colour;
                parentTd.css({'backgroundColor': backgroundColor});
            }
        },{
            'targets' : [-1],
            //'width' : '5%',
            ...
            'createdCell' : function(td, cellData, rowData, row, col){
                ...
                button_1.bind("click", function(){
                    var url = "{!! route('factory.edit', ['#factory']) !!}";
                    url = url.replace("#factory", encodeURIComponent(rowData.name));
